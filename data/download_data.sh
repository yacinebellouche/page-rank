...
echo "   cd ../scripts"
echo "   Membre 1: bash test_config_2workers.sh"
echo "   Membre 2: bash test_config_4workers.sh"
echo "   Membre 3: bash test_config_6workers.sh"
echo "   Puis: bash compile_results.sh"
echo ""
