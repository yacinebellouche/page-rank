...
# ============================================================================
# SCRIPT AUTOMATIQUE - TEST AVEC 4 WORKERS
# ============================================================================
# Ce script exécute TOUT automatiquement pour la configuration 4 workers:
# 1. Crée le cluster
...
REGION="europe-west1"
CLUSTER_NAME="pagerank-cluster-4w"
...
echo "  3. Lancez ./test_config_6workers.sh pour tester 6 workers"
echo ""
