...
# ============================================================================
# SCRIPT AUTOMATIQUE - TEST AVEC 6 WORKERS
# ============================================================================
# Ce script exécute TOUT automatiquement pour la configuration 6 workers:
# 1. Crée le cluster
...
echo "  3. Comparez avec les autres configurations"
echo ""
